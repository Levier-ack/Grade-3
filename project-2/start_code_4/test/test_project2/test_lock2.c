...
void lock_task1(void)
{
        ...
        while (1)
        {
                ...
                sys_move_cursor(1, print_location);
                printf("> [TASK] Applying for a lock_1.\n");
                ...
                {
                        sys_move_cursor(1, print_location);
                        printf("> [TASK] Has acquired lock and running_1.(%d)\n", i);
                }
...
void lock_task2(void)
{
        ...
        while (1)
        {
                ...
                sys_move_cursor(1, print_location);
                printf("> [TASK] Applying for a lock_2.\n");
                ...
                {
                        sys_move_cursor(1, print_location);
                        printf("> [TASK] Has acquired lock and running_2.(%d)\n", i);
                }
